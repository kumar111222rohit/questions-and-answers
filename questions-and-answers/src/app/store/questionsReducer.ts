...
import { sortQuestionsAlphabetically } from '../utils/sortQuestions';
...
export const { addQuestion, editQuestion, deleteQuestion, deleteAllQuestions, sortQuestions } = questionsSlice.actions;
